...
REMOTION_DIR = os.path.realpath(os.path.join(os.path.dirname(__file__), "visualizer"))
...
def render(
    ...
    print("WhisperX JSON → podcast.whisperx.json")
